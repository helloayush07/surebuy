		...
		<thead>
			<tr>
			   <th class="text-center" scope="col">S.L</th>
				<th class="text-center" scope="col">Cust Name</th>
				<th class="text-center" scope="col">IMEI/Serial.</th>
				<th class="text-center" scope="col">Phone</th>
				<th class="text-center" scope="col">Staff Received</th>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
		...
		<center><img src="Surebuy.png" width="300px" height="80px" alt=""></center>
...
<label for="inputEmail4">IMEI Number/model</label>
<input type="text" class="form-control" name="card_no" placeholder="Enter Imei" maxlength="50" required>
</div>
<div class="form-group col-md-6">
...
<div class="form-group col-md-6">
<label for="aadharno">Phone Brand</label>
<input type="text" class="form-control" name="user_aadhar" maxlength="50" placeholder="Ex. vivo v23 " required>
</div>
</div>
...
<div class="form-group col-md-6">
<label for="inputPassword4">Date of Selling</label>
<input type="date" class="form-control" name="user_dob" placeholder="Date of Selling" required>
</div>
</div>
...
<input type="text" class="form-control" name="village" placeholder="Time" required>
</div>
<div class="form-group">
<label for="inputAddress2">Branch</label>
<input type="text" class="form-control" name="police_station" placeholder="Enter Branch" required>
</div>
<div class="form-row">
<div class="form-group col-md-6">
...
<div class="form-group">
<label for="inputAddress">Staff Who Received</label>
<input type="text" class="form-control" name="staff_id" maxlength="30" placeholder="Enter Staff Name">
</div>
			...
			<div class='container' id='profile'> 
				<div class='row'>
					<div class='col-sm-4 col-md-2'>
						...
						<i aria-hidden='true'><b>IMEI:</b></i> $card<br>
						<i ' aria-hidden='true'><b>Phone :</b></i> $phone  <br>
						<b>Uploaded at :</b> $time
					</div>
					<div class='col-sm-3 col-md-6'>
						...
						<strong>Brand model :</strong> $aadhar <br>
						<i class='fa fa-venus-mars' aria-hidden='true'></i> $gender
						<br />
						<i  aria-hidden='true'><b>Mail :</b></i> $email
						<br />
						...
						<i  aria-hidden='true'> <b>Time :</b> </i> $village <br>
						
						<i  aria-hidden='true'><b>Received :</b></i> $u_staff_id
						<br />
						<i  aria-hidden='true'> <b>Branch: </i>  $police </b> <br>
						<i  aria-hidden='true'><b>Address :</b></i> $dist, $state - $pincode
						</p>
						<!-- Split button -->
					</div>
				</div>
  ...
  <div class='modal-dialog'>
    ...
    <div class='modal-content'>
      ...
      <div class='modal-body'>
		...
		<input type='text' class='form-control' name='card_no' placeholder='Enter IMEI Number.' maxlength='50' value='$card' required>
		</div>
		<div class='form-group col-md-6'>
		<label for='inputPassword4'>Mobile No.</label>
		...
		<div class='form-group col-md-6'>
		<label for='aadharno'>Phone Brand.</label>
		<input type='text' class='form-control' name='user_aadhar' maxlength='50' placeholder='Ex vivo v23' value='$aadhar'>
		</div>
		</div>
		...
		<input type='date' class='form-control' name='user_dob' placeholder='Date of Selling' value='$Bday'>
		</div>
		</div>
		...
		<div class='form-group'>
		<label for='inputAddress'>Time</label>
		<input type='text' class='form-control' name='village' placeholder='Time' value='$village'>
		</div>
		<div class='form-group'>
		<label for='inputAddress2'>Branch</label>
		<input type='text' class='form-control' name='police_station' placeholder='Enter branch' value='$police'>
		</div>
		<div class='form-row'>
		<div class='form-group col-md-6'>
		<label for='inputCity'>District</label>
		...
		<div class='form-group'>
		<label for='inputAddress'>Staff who received.</label>
		<input type='text' class='form-control' name='staff_id' maxlength='30' placeholder='Enter staff details' value='$staffCard'>
		</div>
